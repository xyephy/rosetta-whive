...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for xyephy/rosetta-whive
...
execute() {
  ...
  docker tag "rosetta-whive:${TAG}" "rosetta-whive:latest"
  log_info "loaded rosetta-whive:${TAG} and tagged as rosetta-whive:latest"
  rm -rf "${tmpdir}"
